...
export default function OwnerDashboard() {
  ...
  // ✅ Build query parts WITHOUT nested backticks
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex gap-3 items-center">
        ...
        />
        {/* TODO: replace with real location selector and call setLocationId(...) */}
      </div>
